...
config :offtherecord,
  ash_domains: [Offtherecord.Record, Offtherecord.Accounts],
...
config :offtherecord, OfftherecordWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: OfftherecordWeb.ErrorHTML, json: OfftherecordWeb.ErrorJSON],
    layout: false
  ],
...
config :offtherecord, Offtherecord.Mailer, adapter: Swoosh.Adapters.Local
